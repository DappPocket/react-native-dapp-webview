...
import { ActivityIndicator, Text, UIManager as NotTypedUIManager, View, requireNativeComponent, NativeModules, Image, findNodeHandle, } from 'react-native';
import invariant from 'invariant';
import { defaultOriginWhitelist, createOnShouldStartLoadWithRequest, getViewManagerConfig, } from './WebViewShared';
...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.getCommands = function () {
            return getViewManagerConfig('RNCWKWebView').Commands
